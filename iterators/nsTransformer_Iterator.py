...
def optimize(model, optimizer, data, batch_size, data_dim, out_dim, criterion, pred_len, seq_len, attn=False):
    ...
    x, x_dec, y = utils.input_provider.get_input(data, pred_len, seq_len, data_dim, out_dim, two_inputs=True, lstm=True)
...
def predict(model, data, train_data, batch_size, data_dim, out_dim, criterion, mae_crit, pred_len, seq_len,
    ...
    x, x_dec, y = utils.input_provider.get_input(train_data, pred_len, seq_len, data_dim, out_dim, two_inputs=True, lstm=True)
