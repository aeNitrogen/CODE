...
class S4Block(nn.Module):
    ...
    def __init__(
        ...
        **layer_args,  # Arguments into inner layer (e.g. FFTConv)
        ...
        # moved cause self.layer was accessed
        ...
        self.channels = self.layer.channels  # added cause channels werent defined
        ...
        if gate is not None:
            ...
            # if self.layer.d_output != self.d_model * gate or gate == 1: # " or gate == 1" edited in, editerd out cause needed
